...
simpathroot = "/Users/bradwang/Documents/UoE/MScAI/MLP/galaxy_data/"
...
def namemodel(params):
    ...
    return simsuite+"_"+simset+"_model_"+use_model+"_lr_{:.2e}_weightdecay_{:.2e}_layers_{:d}_hiddenc_{:d}_knn_{:.2e}_epochs_{:d}".format(learning_rate, weight_decay, n_layers, hidden_channels, k_nn, n_epochs)
